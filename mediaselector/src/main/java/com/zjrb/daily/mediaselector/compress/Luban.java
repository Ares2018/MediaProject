...
public class Luban implements Handler.Callback {
    ...
    private File getImageCacheDir(Context context, String cacheName) {
        String dir = MediaFileUtils.getDiskCacheDir(context);
                    ...
                    public void run() {
                        try {
                            ...
                            if (medias != null && medias.size() > 0) {
                                MediaEntity media = medias.get(index);
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_COMPRESS_MULTIPLE_SUCCESS:
                mCompressListener.onSuccess((List<MediaEntity>) msg.obj);
                break;
    ...
    public static class Builder {
        ...
        public Builder loadMediaEntity(List<MediaEntity> list) {
            if (list == null) {
                list = new ArrayList<>();
            }
            this.medias = list;
            for (MediaEntity media : list) {
                this.mPaths.add(media.getPath());
            }
            return this;
        }
