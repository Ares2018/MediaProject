package com.zjrb.daily.mediaselector.dao;
...
public class LocalMediaDaoHelper {
    ...
    public LocalMediaDaoHelper(Context context) {
    ...
    private SparseArray<String> queryThumbnails() {
        ...
        Cursor cursor = context.getContentResolver().query(IMAGE_THUMBNAILS_URI,
...
//        AppUtils.scanFile(null); // 全盘的扫描，否则新加入的图片是无法得到显示的
        ...
        Cursor cursor = context.getContentResolver().query(IMAGES_URI,
...
//        AppUtils.scanFile(null); // 全盘的扫描，否则新加入的图片是无法得到显示的
        ...
        Cursor cursor = context.getContentResolver().query(VIDEO_URI,
...
//        AppUtils.scanFile(null); // 全盘的扫描，否则新加入的图片是无法得到显示的
        ...
        Cursor cursor = context.getContentResolver().query(AUDIO_URI,
